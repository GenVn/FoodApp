   ...
   return (
      <section className="w-full my-6" id="menu">
         <div className="w-full flex flex-col items-center justify-center">
          ...
          before:-bottom-2 before:left-0 before:bg-orange-500 before:bg-gradient-to-tr
          from-orange-400 to-orange-600 mr-auto"
            >
               Our Hot Dishes
            </p>
                     ...
                     <motion.div
                        ...
                        className={`group ${
                           filter === category.urlParamName
                              ? "bg-cartNumBg"
                              : "bg-card"
                        } w-24 min-w-[94px] h-28 cursor-pointer rounded-lg shadow-lg 
          drop-shadow-xl flex flex-col gap-3 items-center justify-center duration-150 transition-all
