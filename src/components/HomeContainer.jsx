    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        >
          ...
          architecto tenetur fugit, incidunt voluptate temporibus aspernatur
          provident totam eius quo, animi excepturi facilis expedita maiores
          numquam blanditiis adipisci asperiores delectus!
        </p>
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        />
        <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-8 gap-4 flex-wrap mt-3">
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
